...
document.querySelectorAll('a[href$="/what-we-build.html"], a[href="/what-we-build.html"]').forEach(link => {
  link.setAttribute('href', 'https://praxis-uk.digital/what-we-build.html');
});
